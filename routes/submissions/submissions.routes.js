...
import { addQuizSubmission, addStudentSubmission, deleteStudentSub, getAllQuizSubmissionsForCourse, getQuizSubmissions } from '../../controllers/submission/submissions.students.js';
...
router.get('/submissions/lecturers/get-quiz-all', getAllQuizSubmissionsForCourse)
router.get('/submissions/student/get-quiz', getQuizSubmissions)
